...
public class Manager_Table extends SQLiteOpenHelper
{
    Context context;
    private static String DATABASE_NAME="ManagerDb.db";
    private static int DATABASE_VERSION=2;
    //String name, String username, String passwrod, String email, String mobileNo, String address, String status
    private static String createTableQuery="create table ManagerTable(name TEXT, username TEXT PRIMARY KEY,password TEXT ,email TEXT,mobileNo TEXT,address TEXT,status TEXT)";


    public Manager_Table(Context context)
    {
    ...
    public boolean Register(Manager staff)
    {
        ...
        values.put("password",staff.getPasswrod());
        ...
        long result = db.insert("ManagerTable", null, values);//insert
    ...
    public List<Staff> getAllStaff() {
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM ManagerTable" ;
    ...
    public Cursor getAllData() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select * from ManagerTable" , null);
        return res;
    }
    ...
    {//UserID ,Password
        ...
        Cursor cursor = db.query("ManagerTable", columns, selection, selectionArgs, null, null, null);
